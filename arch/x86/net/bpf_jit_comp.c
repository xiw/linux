...
#define SEEN_SKBREF  1 /* use pointer to skb */
#define SEEN_XREG    2 /* ebx is used */
#define SEEN_MEM     4 /* use mem[] for temporary storage */
#define SEEN_DATAREF (8 | SEEN_SKBREF) /* might call external helpers */
#define SEEN_SECCOMP 16                /* seccomp filters */
...
{
	u8 seen_all = SEEN_XREG | SEEN_MEM | SEEN_DATAREF;
